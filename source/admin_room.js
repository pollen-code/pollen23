...
import {StyleSheet, ActivityIndicator, Dimensions,
        ...
        KeyboardAvoidingView, FlatList, TouchableHighlight,
    } from 'react-native';
...
export default class admin_room extends React.Component {
    ...
    async componentDidMount() {
        ...
        if( status_ == 'left' ) {  
            old_timestamp = room_message_info[roomID][5] 
        }          

        url = `http://${serverLocation}:80/get_admin_messages_rooms?`
        await fetch(url, {
            method:'POST',
            headers:{    
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={{flex:4, justifyContent:'center', alignContent:'center', alignItems:'center' }}>
                    <Text style={{color:'black', fontSize:24*factor_ver, fontWeight:'500', fontFamily:'avenir next', }}>Admin Room</Text>
                </View>
                <View style={{flex:1,}}></View>
            </View>           
