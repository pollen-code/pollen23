...
import {StyleSheet, Dimensions, ScrollView, Text, 
        View, TouchableOpacity, Platform, Linking} from 'react-native';
      ...
      return (
        <View style={styles.container}>
            ...
            <View style={{height:'5%',  flexDirection:'row', borderBottomColor:'#9B9B9B', borderBottomWidth:0, alignSelf:'stretch', justifyContent:'center', justifyContent:'center', alignItems:'center'}}>
                    ...
                    <View style={{flex:7, }}>    
                        <Text style={{textAlign:'center', justifyContent:'center', alignItems:'center', alignContent:'center', fontSize:24*factor_hor, fontFamily:'Avenir next', fontWeight:'500', color:'black'}}>Privacy Policy</Text>
                    </View>
